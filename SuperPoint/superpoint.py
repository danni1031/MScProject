...
class SuperPoint(nn.Module):
    ...
    def __init__(self, config, **conf):
        ...
        path = "/cs/student/projects1/ml/2023/dainlee/SuperPoint/weights/sellafinal.pth"
        self.load_state_dict(torch.load(str(path)))#,weights_only=True,strict=False
        print("loaded FINAL sella sp model!!!")
        self.to(device)
